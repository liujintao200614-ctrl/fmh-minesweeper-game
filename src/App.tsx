...
export default function App() {
      ...
      if (web3.isConnected) {
        setTimeout(async () => {
          try {
            ...
            await gameHistory.completeGame(gameData, userProfile.profile?.id);
  ...
  }, [gameState.board, gameState.gameStatus, gameState.timeElapsed, gameState.flagCount, firstClick, gameConfig, contractGameId, gameContract.completeGame, web3.isConnected, web3.account, gameHistory, userProfile, flagMode]);
    ...
    <AppContainer>
      <GameContainer>
        ...
        <GameHeader
          ...
          onClaimReward={() => console.log('Claim reward clicked')}
          canClaimReward={web3.isConnected && web3.isOnCorrectNetwork && contractGameId !== null && gameState.gameStatus === 'won'}
